...
export const api = {
  ...
  ssoStart: (body) => request('/v1/auth/sso/auth0/start', { method: 'POST', body: JSON.stringify(body) }),
  ssoAuth0: (body) => request('/v1/auth/sso/auth0', { method: 'POST', body: JSON.stringify(body) }),
