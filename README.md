...
| 07 | **Project** | `projeter` | Roadmap, resources, foresight | Trajectory + loop | `POST/GET /v1/ideas/:id/roadmap` (EF-39/40/41 🟢 : roadmap + Monte-Carlo déterministe + rapport d'impact tracé) + `POST/GET /v1/ideas/:id/risques` (EF-42 🟢 : matrice 5×5 + gate `re_arbitrage`) |
