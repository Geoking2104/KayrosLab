...
function New-MarkPng([int]$size, [string]$out, [bool]$withName) {
  ...
  $g.Clear([System.Drawing.Color]::FromArgb(255, 5, 12, 18))
  $r = [int]($size * 0.19)
  ...
  $path.CloseFigure()
  $brush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(255, 21, 25, 29))
  ...
  $ink = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(255, 242, 240, 233))
  ...
  if ($withName) {
    ...
    $mf.Fmt = $fmt
    $g.DrawString('KayrosLab', $mf, (New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(255, 230, 241, 244))), (New-Object System.Drawing.RectangleF($size, 0, ($w - $size), $h)), $fmt)
  }
